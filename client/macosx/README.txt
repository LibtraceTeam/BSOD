BSOD Client 2.0.3 for Mac OS X

-------------------------------------------------------------------------------
Copyright (c) 2005-2013 The University of Waikato, Hamilton, New Zealand.
All rights reserved.
...
This package contains a precompiled Mac OS X app bundle of BSOD client, a 
...
Configuration below) and then simply double-click on the bsodclient application.
...
The application bundle for Mac OS X was created by Shane Alcock.
